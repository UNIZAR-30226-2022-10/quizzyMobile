...
export class Player extends Actor{
    ...
    constructor(private texture: PIXI.Texture, private _app: PIXI.Application){
        super();
            ...
            this.addChild(new TrivialCell(this.app.screen.width/22, this.app.screen.height/22, this.children[0] as TrivialCell,dude));
    }
    ...
    createArrayCells(app: PIXI.Application, dude: PIXI.Sprite){
      this.cells =[
        ...
        new TrivialCell(app.screen.width/45,                       0, this.children[0] as TrivialCell,dude),
        new TrivialCell(app.screen.width/37,                       0, this.children[0] as TrivialCell,dude), // 20
